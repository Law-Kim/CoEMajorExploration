...
<form id="quiz">
  ...
  <button type="submit" id="submit" onclick="window.location.href = 'http://www.google.com'">Submit Your Answers</button>
  <button type="reset" id="reset" onclick="window.location.href = 'http://www.google.com'">Reset</button>
  </form>
